...
# Form implementation generated from reading ui file 'uamodeler_ui.ui'
#
...
class Ui_UaModeler(object):
    def setupUi(self, UaModeler):
        ...
        self.Demo1Button = QtWidgets.QPushButton(self.frame)
        self.Demo1Button.setObjectName("Demo1Button")
        self.verticalLayout.addWidget(self.Demo1Button)
        self.Demo2Button = QtWidgets.QPushButton(self.frame)
        self.Demo2Button.setObjectName("Demo2Button")
        self.verticalLayout.addWidget(self.Demo2Button)
        ...
        self.label.raise_()
        self.Demo2Button.raise_()
        self.Demo1Button.raise_()
        ...
        self.actionConfigure = QtWidgets.QAction(UaModeler)
    ...
    def retranslateUi(self, UaModeler):
        ...
        self.actionConfigure.setText(_translate("UaModeler", "Configure"))
